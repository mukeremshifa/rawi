/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 9791ab17e8d37fe6b1f75eea2386e6a3)
// Runtime types generated with workerd@1.20260911.1 2026-09-14 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	RAWI_STORAGE_MODE: "supabase";
	RAWI_OPENAI_MODEL: "gpt-5.6-luna";
	RAWI_OPENAI_INPUT_USD_PER_MILLION: "0.20";
	RAWI_OPENAI_OUTPUT_USD_PER_MILLION: "1.20";
	RAWI_AI_TIMEOUT_MS: "8000";
	RAWI_UPLOADS_ENABLED: "false";
	RAWI_RETENTION_DAYS: "30";
	SUPABASE_URL: string;
	SUPABASE_ANON_KEY: string;
	SUPABASE_SERVICE_KEY: string;
	RAWI_TUTOR_MODE: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RAWI_STORAGE_MODE" | "RAWI_OPENAI_MODEL" | "RAWI_OPENAI_INPUT_USD_PER_MILLION" | "RAWI_OPENAI_OUTPUT_USD_PER_MILLION" | "RAWI_AI_TIMEOUT_MS" | "RAWI_UPLOADS_ENABLED" | "RAWI_RETENTION_DAYS" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_KEY" | "RAWI_TUTOR_MODE">> {}
}
